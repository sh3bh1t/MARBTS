...
def main() -> None:
    ...
    print(f"summary_file={output['summary_file']}")
    print(f"compromise_trend_figure={output['figure_files']['compromise_trend']}")
    print(f"defense_efficiency_figure={output['figure_files']['defense_efficiency']}")
    print(f"response_latency_figure={output['figure_files']['response_latency']}")
